 ...
 * 保存一行的访问记录
 */
public class LHAccessRecord
{
	public static int g_processCount = 0; //用于记录处理的合法的log条数，最后计算百分比
	private static LHAccessRecord g_accessRecord = null;
    ...
    public static LHAccessRecord getInstance()
    {
        if(g_accessRecord == null)
        {
        	g_accessRecord = new LHAccessRecord();
        }
        
        return g_accessRecord;
    }
    
    public LHAccessRecord parser(String aLine)
    {
        ...
        if (arr.length > 11)
        {
            ...
            //排除log中的一个错误记录
            {
                ...
                if (Integer.parseInt(getStatus()) >= 400)
                {// 大于400，HTTP错误
                    setValid(false);
                }            	
     ...
     * 按page的pv分类
     */
    public LHAccessRecord filterPVs(String aLine)
    {
        ...
        LHAccessRecord kpi = g_accessRecord.parser(aLine);
     ...
     * 按page的独立ip分类
     */
    public LHAccessRecord filterIPs(String aLine)
    {        
     ...
     * 按page的发送字节数
     */
    public LHAccessRecord filterPageSize(String aLine)
    {        
        return g_accessRecord.parser(aLine);
    }
     ...
     * PV按浏览器分类
     */
    public LHAccessRecord filterBroswer(String aLine)
    {
        LHAccessRecord kpi = g_accessRecord.parser(aLine);
     ...
     * PV按小时分类
     */
    public LHAccessRecord filterTime(String line)
    {
     ...
     * PV按小时分类
     */
    public LHAccessRecord filterRegion(String aLine)
    {
        return g_accessRecord.parser(aLine);
    }
     ...
     * PV按访问域名分类
     */
    public LHAccessRecord filterDomain(String aLine)
    {
        LHAccessRecord kpi = g_accessRecord.parser(aLine);
    ...
    public static void main(String args[])
    {
        ...
        LHAccessRecord kpi = LHAccessRecord.getInstance();
